...
static int __maybe_unused __read_only neg_one = -1;
static int __maybe_unused __read_only neg_three = -3;

static int __maybe_unused __read_only one = 1;
static int __maybe_unused __read_only two = 2;
static int __maybe_unused __read_only three = 3;
static int __maybe_unused __read_only four = 4;
...
static int max_swappiness __read_only  = 200;
#endif
